            ...
            children: [
              ...
              InkWell(
                ...
                child: AnimatedContainer(
                  duration: Duration(seconds: 2),
                  height: controller.pinVisible.value == 1 ? 50 : 60,
                  width: controller.pinVisible.value == 1 ? 50 : 140,
                  decoration: BoxDecoration(
                      color: AppColors.ccsYelow,
                      borderRadius:
                      BorderRadius.circular(controller.pinVisible.value == 1 ? 60 : 10)),
                  alignment: Alignment.center,
                  child: controller.pinVisible.value == 1
