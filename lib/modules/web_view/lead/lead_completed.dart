...
class LeadCompletedWebView extends StatefulWidget {
  @override
  _projectCompletedWebViewClassState createState() => _projectCompletedWebViewClassState();
}

class _projectCompletedWebViewClassState extends State<LeadCompletedWebView> {
  ...
  var controller = WebViewController()
    ...
    ..loadRequest(Uri.parse(Get.find<AuthService>().currentUser.value.userInfo!.roleName == "contractor"
        ?ApiUrl.projectsCompletedUrl+Get.find<AuthService>().apiToken : ApiUrl.projectsCompletedUrl+Get.find<AuthService>().apiToken));
  void initState() {
    super.initState();
