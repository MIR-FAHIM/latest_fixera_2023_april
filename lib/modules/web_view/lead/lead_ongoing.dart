...
class LeadOngoingWebView extends StatefulWidget {
  @override
  _projectWebViewClassState createState() => _projectWebViewClassState();
}

class _projectWebViewClassState extends State<LeadOngoingWebView> {
  ...
  var controller = WebViewController()
    ...
    ..loadRequest(Uri.parse(ApiUrl.leadOngoingUrl+Get.find<AuthService>().apiToken));
  void initState() {
    super.initState();
