...
class LeadManageWebView extends StatefulWidget {
  @override
  _projectManageWebViewClassState createState() => _projectManageWebViewClassState();
}

class _projectManageWebViewClassState extends State<LeadManageWebView> {
  ...
  var controller = WebViewController()
    ...
    ..loadRequest(Uri.parse(ApiUrl.leadManageJobsUrl+Get.find<AuthService>().apiToken));
  void initState() {
    super.initState();
