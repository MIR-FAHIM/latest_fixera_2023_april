...
class WalletIncomeWebView extends StatefulWidget {
  @override
  _walletIncomeWebViewClassState createState() => _walletIncomeWebViewClassState();
}

class _walletIncomeWebViewClassState extends State<WalletIncomeWebView> {
