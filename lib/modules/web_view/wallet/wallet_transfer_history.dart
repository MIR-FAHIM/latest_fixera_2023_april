...
class WalletTransferWebView extends StatefulWidget {
  @override
  _walletTransferWebViewClassState createState() => _walletTransferWebViewClassState();
}

class _walletTransferWebViewClassState extends State<WalletTransferWebView> {
