...
class PackagesWebView extends StatefulWidget {
  @override
  _packagesWebViewClassState createState() => _packagesWebViewClassState();
}

class _packagesWebViewClassState extends State<PackagesWebView> {
  ...
  var controller = WebViewController()
    ...
    ..loadRequest(Uri.parse(ApiUrl.vendorPackagesUrl+Get.find<AuthService>().apiToken));
  void initState() {
    super.initState();
