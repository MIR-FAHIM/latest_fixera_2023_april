...
class BuyCreditWebView extends StatefulWidget {
  @override
  _buyCreditWebViewClassState createState() => _buyCreditWebViewClassState();
}

class _buyCreditWebViewClassState extends State<BuyCreditWebView> {
  ...
  var controller = WebViewController()
    ...
    ..loadRequest(Uri.parse(ApiUrl.buyCreditUrl+Get.find<AuthService>().apiToken));
  void initState() {
    super.initState();
