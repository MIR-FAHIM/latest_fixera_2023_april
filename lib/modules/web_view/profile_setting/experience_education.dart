...
class ExperienceAndEduWebView extends StatefulWidget {
  @override
  _manageAccountWebViewClassState createState() =>
      _manageAccountWebViewClassState();
}

class _manageAccountWebViewClassState extends State<ExperienceAndEduWebView> {
  var controller = WebViewController()
    ...
    ..loadRequest(Uri.parse(
        ApiUrl.contrctorExEdu + Get.find<AuthService>().apiToken));
  void initState() {
    super.initState();
  }
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text("Experience and Education"),
          centerTitle: true,
        ),
