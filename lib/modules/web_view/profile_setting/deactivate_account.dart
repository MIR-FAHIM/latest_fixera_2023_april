...
class DeactivateWebView extends StatefulWidget {
  @override
  _manageAccountWebViewClassState createState() =>
      _manageAccountWebViewClassState();
}

class _manageAccountWebViewClassState extends State<DeactivateWebView> {
  var controller = WebViewController()
    ...
    ..loadRequest(Uri.parse(
        ApiUrl.deactivateAccount + Get.find<AuthService>().apiToken));
  void initState() {
    super.initState();
  }
