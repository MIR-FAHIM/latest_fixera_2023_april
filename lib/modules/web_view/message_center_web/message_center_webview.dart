...
class MessageCenterWebView extends StatefulWidget {
  @override
  _WebViewClassState createState() => _WebViewClassState();
}

class _WebViewClassState extends State<MessageCenterWebView> {
  ...
  var controller = WebViewController()
    ...
    ..loadRequest(Uri.parse(ApiUrl.messageCenterUrl+Get.find<AuthService>().apiToken));
  void initState() {
    super.initState();
