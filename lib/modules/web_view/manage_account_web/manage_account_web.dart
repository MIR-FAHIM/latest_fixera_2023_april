...
class ManageAccountWebView extends StatefulWidget {
  @override
  _manageAccountWebViewClassState createState() =>
      _manageAccountWebViewClassState();
}

class _manageAccountWebViewClassState extends State<ManageAccountWebView> {
  var controller = WebViewController()
    ...
    ..loadRequest(
        Uri.parse(ApiUrl.manage_account + Get.find<AuthService>().apiToken));
  void initState() {
    super.initState();
  }
